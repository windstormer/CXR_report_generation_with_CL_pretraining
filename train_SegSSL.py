...
if __name__ == '__main__':
    ...
    model_name = "SegSSL_p{}_ep{}_b{}".format(args.patch_size, args.epochs, args.batch_size)    
    ...
    print("============== Load Dataset ===============")
    train_dataset = SegSSLTrainDataset(args, 'train')
    ...
    val_dataset = SegSSLTrainDataset(args, 'val')
